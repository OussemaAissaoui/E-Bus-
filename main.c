...
void creecompt() {
  ...
  do {printf("Merci d'entrer votre nom :");
  scanf("%s", & v.NOM);} while (isAlpha(v.NOM)==0);
  do{printf("Merci d'entrer votre prenom :");
  scanf("%s", & v.PRENOM);}while (isAlpha(v.PRENOM)==0);
  do {
...
int reserver() {
  char destinations[24][30] = {
        ...
        "Jendouba", "Kairouan", "Mahdia", "Medenine", "Monastir", "Nabul", "kbili","Safax", "SidiBouzid",
 ...
 printf("\t\t\t\t ___________________________________________________________________________ \n");
  ...
  printf("\t\t\t\t| 6 : El Kef               | 16 : safax             | 22 : Tunis            |\n");
...
void modifier(int y) {
  ...
  printf("\t\t\t\t| 2 : modifier la destination                     | \n");
